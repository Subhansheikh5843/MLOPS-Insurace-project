...
class ModelTrainer:
  ...
  def initiate_model_trainer(self)->ModelTrainerArtifact:
    ...
    try:
        ...
        logging.info(f"train_arr type: {type(train_arr)}, shape: {None if train_arr is None else train_arr.shape}")
        logging.info(f"test_arr type: {type(test_arr)}, shape: {None if test_arr is None else test_arr.shape}")
        ...
        save_object(self.model_trainer_config.trainer_model_file_path,my_model)
