...
class DataTransformation:
  ...
  def _map_gender_column(self,df)->pd.DataFrame:
    ...
    logging.info("Mapping Gender Column to 0 for Female and 1 for male")
    try:
  ...
  def initiate_data_transformation(self)->DataTransformationArtifact:
      ...
      try:
        ...
        logging.info(f"checking self.data_validation_artifact.validation_status : {self.data_validation_artifact.validation_status}")
        if not self.data_validation_artifact.validation_status:
          logging.info(f"True : error mesage is : {self.data_validation_artifact.message}")
          
          raise Exception(self.data_validation_artifact.message)
        # Load train and test data 
        train_df = self.read_csv(self.data_ingestion_artifact.trained_file_path)
        ...
        logging.info("saving the preprocessor object and transformed train arr and test arr")
